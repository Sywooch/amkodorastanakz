...
<!--                    </li>-->
                    ...
                    <li>
                        <a href="<?= Url::to(['/store/admin/sparescategory']) ?>">Категории запчастей</a>
                    </li>
<!--                    <li>-->
<!--                        <a href="--><?//= Url::to(['/store/admin/order']) ?><!--">Заказы <i-->
<!--                                class="badge">--><?//= \app\modules\store\models\Order::getCount() ?><!--</i></a>-->
<!--                    </li>-->
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <!--<li>
                <a href="#"><i class="fa fa-android fa-fw"></i> Совет директоров<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
