...
<section class="cart-content">
    <div class="cart-content__wrapper">
        ...
        <h2>МОДИФИКАЦИИ</h2>
        <div class="cart-content-modification"><a href="<?=$model->modificatorLink?>" title="" class="cart-content-modification__all"><?=$model->category->modificatorTitle?></a>
            <?php foreach($modificators as $modificator):?>
            <div class="cart-content-modification__item">
                <a href="<?=$modificator->path?>" title=""><img src="<?=$modificator->imageSrc( '134x135',\alexBond\thumbler\Thumbler::METHOD_BOXED)?>" alt=""></a>
